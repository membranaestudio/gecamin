export default class CreatePDF extends BaseComponent {
    ...
    const marginTop = 50; // Define el margen superior para las páginas sin encabezado
    ...
    // Añade el encabezado sólo en la primera página
    ...
    for (const [index, container] of containers.entries()) {
        if (index > 0) {
            pdf.addPage();
            // Establece un margen superior en las páginas sin encabezado
